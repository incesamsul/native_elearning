<div class="content-wrapper">
    <h4> <b>Master</b> <small class="text-muted">/ jurusan</small>
    </h4>
    <hr>
    <div class="row">
        <div class="col-md-10">
            <div class="card">
                ...
                <a data-toggle="modal" data-target="#add" class="btn btn-info text-white pull-right"><i class="fa fa-plus"></i> Add jurusan</a> <br>
                </p>
