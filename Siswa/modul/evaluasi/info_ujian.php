  ...
  <div class="row">
   ...
   <div class="alert alert-info">Belum ada ujian Pada Tanggal Sekarang Untuk Kelas Kamu. Jika ada kesalahan hubungi Guru Mata Pelajaran! perbaiki tanggal ujian atau kelas ujian</div>';
    ...
    ';
              ...
              $qnilai = mysqli_query($con, "SELECT * FROM siswa_sudah_mengerjakan WHERE id_ujian='$r[id_ujian]' AND id_siswa='$_SESSION[id_siswa]' ");
              ...
              if ($tnilai == 1) {
                ...
                <a href="index.php?page=kerjakan&id=' . $r['id_ujian'] . '"> <i class="btn btn-block"><i class="fa fa-check-circle-o"></i> Kerjakan</a>';
                //             echo '
                // <td bgcolor="#FFFF00">
