  															...
  															<div class="alert alert-info">
  																...
  																<Center>
  																	...
  																	<?php
																		...
																		$nilaiQ = mysqli_query($con, "SELECT * FROM nilai_ujian WHERE id_siswa='$_SESSION[id_siswa]' ");
																		$nilaiSiswa = mysqli_fetch_array($nilaiQ);


																		?>
  																	<font size="50px" color="#FF0000"><?= $nilaiSiswa['nilai']; ?> </font>
  																</Center>
  															</div>
  														</div>
